...
/**
 * Class CastBack_Email_acceptOffer_seller
 */
class CastBack_Email_acceptOffer_seller extends WC_Email {
    ...
    // Email slug we can use to filter other data.
		$this->id          = 'CastBack_acceptOffer_seller';
		$this->title       = __( 'CastBack - acceptOffer() - seller', 'castback-email' );
    ...
    // Template paths.
		$this->template_html  = 'CastBack-acceptOffer-seller.php';
		// $this->template_plain = 'emails/plain/CastBack-acceptOffer-seller.php';
		$this->template_plain = 'CastBack-acceptOffer-seller.php';
