<?php
/**
 * CastBack - submitOffer
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/castback-new-offer.php.
 *
...
<p><?php printf( esc_html__( 'Someone has made a new offer on one of your listings!', 'woocommerce' ), esc_html( $blogname ) ); ?></p>
