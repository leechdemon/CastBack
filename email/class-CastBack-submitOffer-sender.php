...
/**
 * Class CastBack_Email_submitOffer_sender
 */
class CastBack_Email_submitOffer_sender extends WC_Email {
    ...
    // Email slug we can use to filter other data.
		$this->id          = 'CastBack_submitOffer_sender';
		$this->title       = __( 'CastBack - submitOffer() - sender', 'castback-email' );
    ...
    // Template paths.
		$this->template_html  = 'CastBack-submitOffer-sender.php';
		// $this->template_plain = 'emails/plain/CastBack-submitOffer-sender.php';
		$this->template_plain = 'CastBack-submitOffer-sender.php';
	...
	function trigger( $user_email, $order_id ) {
		...
		$this->subject     = sprintf( _x( 'Order #'. $order_id. ': New Offer Sent', 'default email subject for New Offer Sent.', 'castback-email' ), 'CastBack' );
