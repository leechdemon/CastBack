...
/**
 * Class Recast_Email_completeOrder_buyer
 */
class Recast_Email_completeOrder_buyer extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-completeOrder-buyer.php';
		$this->template_plain = 'Recast-completeOrder-buyer.php';
