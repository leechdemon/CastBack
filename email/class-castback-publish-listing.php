...
class CastBack_Email_publishListing extends WC_Email {
    ...
    // Email slug we can use to filter other data.
		$this->id          = 'castback_publish_listing';
    ...
    // Template paths.
		$this->template_html  = 'castback-publish-listing.php';
		// $this->template_plain = 'emails/plain/castback-publish-listing.php';
		$this->template_plain = 'castback-publish-listing.php';
