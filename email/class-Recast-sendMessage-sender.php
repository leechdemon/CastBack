...
/**
 * Class Recast_Email_sendMessage_sender
 */
class Recast_Email_sendMessage_sender extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-sendMessage-sender.php';
		$this->template_plain = 'Recast-sendMessage-sender.php';
