...
/**
 * Class Recast_Email_acceptOffer_seller
 */
class Recast_Email_acceptOffer_seller extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-acceptOffer-seller.php';
		$this->template_plain = 'Recast-acceptOffer-seller.php';
