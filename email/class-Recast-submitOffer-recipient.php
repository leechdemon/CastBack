...
/**
 * Class Recast_Email_submitOffer_recipient
 */
class Recast_Email_submitOffer_recipient extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-submitOffer-recipient.php';
		$this->template_plain = 'Recast-submitOffer-recipient.php';
