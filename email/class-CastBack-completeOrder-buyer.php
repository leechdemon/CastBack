...
/**
 * Class CastBack_Email_completeOrder_buyer
 */
class CastBack_Email_completeOrder_buyer extends WC_Email {
    ...
    // Email slug we can use to filter other data.
		$this->id          = 'CastBack_completeOrder_buyer';
		$this->title       = __( 'CastBack - completeOrder() - buyer', 'castback-email' );
    ...
    // Template paths.
		$this->template_html  = 'CastBack-completeOrder-buyer.php';
		// $this->template_plain = 'emails/plain/CastBack-completeOrder-buyer.php';
		$this->template_plain = 'CastBack-completeOrder-buyer.php';
