...
/**
 * Class Recast_Email_autorefundUnshippedOrder_seller
 */
class Recast_Email_autorefundUnshippedOrder_seller extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-autorefundUnshippedOrder-seller.php';
		$this->template_plain = 'Recast-autorefundUnshippedOrder-seller.php';
		$this->template_base  = CASTBACK_EMAIL_PATH;
		
		// Test( $order_id );
    
    // Action to which we hook onto to send the email.
		//add_action( 'Recast_Action_autorefundUnshippedOrder_seller_emailTrigger', array( $this, 'trigger' ) );
