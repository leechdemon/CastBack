...
/**
 * Class Recast_Email_sendMessage_recipient
 */
class Recast_Email_sendMessage_recipient extends WC_Email {
    ...
    // Template paths.
		...
		// $this->template_plain = 'emails/plain/Recast-sendMessage-recipient.php';
		$this->template_plain = 'Recast-sendMessage-recipient.php';
		$this->template_base  = CASTBACK_EMAIL_PATH;
		
		// Test( $order_id );
    
    // Action to which we hook onto to send the email.
		//add_action( 'Recast_Action_sendMessage_emailTrigger', array( $this, 'trigger' ) );
